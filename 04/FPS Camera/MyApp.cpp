...
bool CMyApp::Init()
{
	...
	m_fps_camera_manipulator.SetCamera(&m_camera);
	m_fly_camera_manipulator.SetCamera(&m_camera);
...
void CMyApp::Update( const SUpdateInfo& updateInfo )
{
	...
	//m_camera_manipulator.Update();
	//m_fps_camera_manipulator.Update();
	m_fly_camera_manipulator.Update();
}
...
{	
	...
	if (key.keysym.sym == SDLK_w || key.keysym.sym == SDLK_a || key.keysym.sym == SDLK_s || key.keysym.sym == SDLK_d)
	{
		m_fly_camera_manipulator.KeyboardMove(key);
	}
}
...
void CMyApp::MouseMove(const SDL_MouseMotionEvent& mouse)
{
	...
	m_fps_camera_manipulator.MouseMove(mouse);
}
